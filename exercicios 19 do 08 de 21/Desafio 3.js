let bemvindo = "Bem-Vindo ao caixa eletronico da Blue-Edtech"
console.log(bemvindo)
let saque = parseInt(prompt("Digite o valor do saque(Valor minimo R$10 e valor maximo R$600"));
let totalsaque = saque.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
console.clear();
